...
<head>
   ...
   <title>SUNRISE - ADMINPANEL | PROFILE</title>
...
<section class="form-container">
   ...
   <form action="" method="post">
      ...
      <input type="phone" name="phone" value="<?= $row['phone']; ?>" required placeholder="Enter your phone number" maxlength="40"  class="box" oninput="this.value = this.value.replace(/\s/g, '')">
      ...
      <div class="flex-btn">
         ...
         <a href="../admin/adminhome.php" class="delete-btn">Cancel</a>
      </div>
   </form>
